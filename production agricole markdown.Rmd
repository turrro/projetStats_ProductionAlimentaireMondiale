...
agrifrance2 = agrifrance[,c("Area", "Maize")]
agrifrance2
```
...
agrifrance2 = agrifrance[,c("Year","average_rain_fall_mm_per_year","pesticides_tonnes","avg_temp","Maize","Potatoes","Rice, paddy","Sorghum","Soybeans","Wheat","Cassava","Sweet potatoes","Plantains and others","Yams")]
...
res.pca = PCA(agrifrance2, scale.unit = TRUE, graph = FALSE, ncp=7)
