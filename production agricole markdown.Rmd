...
agri_simplifie = agri[which(agri$Year %in% c("1990","2000","2010") & agri$Item %in% c("Potatoes","Maize","Wheat")),]
agri_simplifie
#na.omit(agri_test)
#agri_test
...
On va essayer maintenant d'expliquer la variabilité du rendement en fonction de plusieurs facteurs grâce à un modèle. Puisqu'on travaille avec des donénes à la fois qualitatives et quantitatives, on va donc faire un modèle d'ANCOVA à plusieurs facteurs :
